...
plot "adc_100k_acq.txt" using 1:17 title "Channel" with lines# ,"adc_100k_acq.txt" using 1:3 title "signal"  with lines,\
    # "adc_100k_acq.txt" using 1:4 title "channel above signal" with lines
