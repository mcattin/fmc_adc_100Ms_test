...
if __name__ == '__main__':
    ...
    print "length of total channels :  ", len(channels)
    channel0 = channels[0:4095:1]
    print "length of channel 0 : ", len(channel0)
    channel1 = channels[4096:8192:1]
    channel2 = channels[8193:12288:1]

  #  filename="./adc_100k_acq_channel_" + str(sample_num)+".txt"
    file = open("adc_100k_acq.txt", 'w')              ##ross
    for i in range(len(channel0)): 
        file.write("%5d,%5d,%5d,%5d\n" % (time_base[i], channel0[i],channel1[i],channel2[i] ))
